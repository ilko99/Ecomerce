                ...
                <input type="email" required="" name="shipping_email" value="{{Auth::user()->email}}" placeholder="email">
                        ...
                        <div class="row shipping_calculator">
                         ...
                         <div class="row shipping_calculator">
                            ...
                            <div class="form-group col-lg-6">
                                <input required="" type="text" name="post_code" placeholder="Posr Code*">
                            </div>
                        </div>
                        ...
                        <div class="row shipping_calculator">
                            ...
                            <div class="form-group col-lg-6">
                                <input required="" type="text" name="shipping_address" value="{{Auth::user()->address}}" placeholder="Address here">
                            </div>
                        </div>
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment_option">
                        ...
                        <div class="custome-radio">
                            ...
                            <label class="form-check-label" for="exampleRadios5" data-bs-toggle="collapse" data-target="#paypal" aria-controls="paypal">With a Card</label>
                        </div>
                    </div>
              ...
              $.ajax({
                ...
                success:function(data){
                  ...
                  $.each(data, function(key, value){
                    $('select[name="district_id"]').append('<option value="'+ value.id + '">' + value.disctrict_name + '</option>');
                  });
                },
              });
            } else {
