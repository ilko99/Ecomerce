...
.track .step.active:before{background: #3bb77e}.track .step::before{height: 7px;position: absolute;content: "";width: 100%;left: 0;top: 18px}
.track .step.active .icon{background: #3bb77e;color: #fff}
...
.track .step.active .text{font-weight: 400;color: #000}.track .text{display: block;margin-top: 7px}.itemside{position: relative;display: -webkit-box;display: -ms-flexbox;display: flex;width: 100%}
...
.btn-warning{color: #ffffff;background-color: #3bb77e;border-color: #3bb77e;border-radius: 1px}.btn-warning:hover{color: #ffffff;background-color: #ff2b00;border-color: #ff2b00;border-radius: 1px}
</style>
        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
                    ...
                    <div class="col"> <strong>Shipping BY:</strong> <br> {{$track->name}} | <i class="fa fa-phone"></i> {{$track->phone}} |{{$track->division->division_name}} |{{$track->district->disctrict_name}} |{{$track->state->state_name}} </div>
                    <div class="col"> <strong>Payment Method:</strong> <br> {{ $track->payment_method }} </div>
                    <div class="col"> <strong>Total Amount #:</strong> <br> ${{ $track->ammount }} </div>
                </div>
            </article>
            <div class="track">
