    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span>{{$product->category->category_name}} <span></span> {{$product->subcategory->subcategory_name}} <span></span> {{$product->product_name}}
            </div>
        </div>
    </div>
...
<ul class="float-start">
    <li class="mb-5">Product_code: <a href="#">{{$product->product_code}}</a></li>
    <li class="mb-5">Tags: <a href="#" rel="tag">{{$product->product_tags}}k</a>, <a href="#" rel="tag">Organic</a>, <a href="#" rel="tag">Brown</a></li>
    <li>Stock:<span class="in-stock text-brand ml-5">{{$product->product_quantitiy}}Items In Stock</span></li>
</ul>
</div>
</div>
                            <!-- Detail Info -->
                    ...
                    <div class="product-info">
                        <div class="tab-style3">
                            <ul class="nav nav-tabs text-uppercase">
                                ...
                                @php
                                $reviewCount = App\Models\Review::where('product_id', $product->id)->get();
                                @endphp
                                <li class="nav-item">
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Reviews">
                                                    ...
                                                    <div class="single-comment justify-content-between d-flex mb-30">
                                                        <div class="user justify-content-between d-flex">
                                                            ...
                                                            <div class="thumb text-center">
                                                                ...
                                                                <img src="{{ (!empty($item->user->photo)) ? url('upload/user_images/' . $item->user->photo) : url('upload/no_image')}}" alt="" />
                                    ...
                                    @else
                                        <p>Please log in to add a review! <a href="{{ route('login') }}">Log in</a></p>
                                    @endauth
                                </div>
                            </div>
                        </div>
