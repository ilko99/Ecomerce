                ...
                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                    ...
                    <div class="shopping-cart-footer">
                        <div class="shopping-cart-total">
                            <h4>Total <span >$</span> <span id="cartTotal"></span></h4>
                        </div>
...
@endphp
    ...
    <div class="header-bottom header-bottom-bg-color sticky-bar">
        ...
        @endphp
                                ...
                                <li>
                                    <a href="{{ url('product/category/' . $category->id . '/' . $category->category_slag)}}">{{$category->category_name}} <i class="fi-rs-angle-down"></i></a>
        @php
