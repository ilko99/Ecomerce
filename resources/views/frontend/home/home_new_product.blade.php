                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div>
                                    @if($product->vendor_id == null)
                                    <span class="font-small text-muted">By <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">Owner</a></span>
                                    @else
                                    <span class="font-small text-muted">By <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug) }}">{{$product->vendor->name}}</a></span>
                                    @endif
                                </div>
                                <div class="product-card-bottom">
                                    @if($product->discount_price == null)
