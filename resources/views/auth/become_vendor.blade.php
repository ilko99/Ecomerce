        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Register</a>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('vendor.register')}}">
                                            ...
                                            <div class="form-group">
                                                <select class="form-select mb-3" aria-label="Default select example" name="vendor_join" id="">
                                                    <option selected="" value="">Open this select Join Date</option>
