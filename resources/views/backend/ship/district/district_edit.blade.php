                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <select name="division_id" class="form-select mb-3" aria-label="Default select example">
                                        ...
                                        <option name="division_id" value="{{$item->id}}" {{$item->id == $district->division_id ? 'selected' : '' }}>{{$item->division_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <div class="form-group col-sm-9 text-secondary">
                                    <input type="text" value="{{$district->disctrict_name}}" name="district_name" class="form-control"/>    
