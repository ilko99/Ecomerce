                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('update.brand') }}" enctype="multipart/form-data" >
                                ...
                                <input type="hidden" id="id" value="{{$brand->image}}">
                                <input type="hidden" id="old_image" value="{{$brand->brand_image}}">
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="cil-sm-9 text-secondary">
                                    <img id="showImage" src="{{asset($brand->brand_image)}}" alt="" style="width: 100px; height: 100px;">
                                </div>
                            </div>
                            <div class="row">
